            ...
            const mailOptions = {
                ...
                html: `
                    <div style="background-color: #66ccaf; padding: 20px; text-align: center; font-family: Arial, sans-serif; color: #260020;">
                        ...
                        <p><a href="http://127.0.0.1:5500/client/pages/delete-account.html?token=${deleteToken}&id=${user.id}" style="background-color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">Confirm delete</a></p>
